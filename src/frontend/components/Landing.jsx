...
const Landing = () => {
  return (
    <>
        <div id='home' className=' bg-slate-800 min-h-screen z-0 relative'>
            <div className='pt-28 relative z-20'>
                ...
                <div className='pt-4 2xl:w-1/2 '>
                    ...
                    <p className='z-50 text-white text-left 2xl:mx-20 mx-10 py-2 px-8 rounded-3xl 2xl:text-[28px] bg-slate-900 hover:text-slate-900 hover:bg-white duration-150 animate-bounce w-fit'>Let's scroll down to hit the store </p>
                </div>
            </div>
            <div className='flex absolute bottom-0 right-0 justify-end z-10'>
                <div className='select-none ml-24 w-[15rem] h-[20rem] 2xl:w-[40rem] 2xl:h-[40rem] rounded-tl-full bg-slate-900'></div>
