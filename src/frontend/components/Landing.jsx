        ...
        <div id='home' className=' bg-slate-800 min-h-screen z-0 relative'>
            <div className='pt-28 relative z-20'>
                ...
                <div className='pt-4 2xl:w-1/2'>
                    <a href='#store' className='z-50 text-white text-left 2xl:mx-20 mx-10 py-2 px-8 rounded-3xl 2xl:text-[28px] bg-slate-900 hover:text-slate-900 hover:bg-white duration-150'>Let's hit the store</a>
                </div>
            </div>
