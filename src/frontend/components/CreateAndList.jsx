    ...
    <div>
        ...
        <div className='bg-slate-300 min-h-screen'>
            <div id="listNFT" className='2xl:w-[35vw] xl:w-[35vw] lg:w-[35vw] w-full'>
                ...
                <div className='px-8'>
                    <section className='bg-white shadow-lg shadow-black rounded-xl py-4 my-10  '>
                    <div class=" px-10 pt-4 ">
                        ...
                        <div className='flex justify-between'>
                          <button className="block uppercase tracking-wide text-white text-xs 2xl:text-lg font-bold mb-2 mt-8 bg-slate-800  px-2 2xl:px-4 py-2 rounded-3xl hover:bg-white hover:text-slate-800 hover:border-slate-800 border-2" 
                              onClick={createNFT}>
                              Create and List NFT
                          </button>
                          <p className='pt-12 2xl:text-[20px] text-[12px]  text-teal-500 animate-pulse font-bold'>{msg}</p>
                        </div>
                    </div>
